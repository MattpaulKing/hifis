 ...
 */
const SERVERS = {
  "POST /api/v1/buildable/create": `/api/v1/buildable/create`,
 ...
 */
const ACTIONS = {
  "default /[orgLabel]": (params: { orgLabel: (string | number) }) => {
    return `/${params.orgLabel}`
  },

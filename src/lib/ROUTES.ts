...
const ACTIONS = {
  ...
  "default /[orgLabel]/custom-entities/properties": (params: { orgLabel: (string | number) }) => {
    return `/${params.orgLabel}/custom-entities/properties`
  },
